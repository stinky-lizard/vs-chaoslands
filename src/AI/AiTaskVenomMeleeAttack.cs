...
{
    public class AiTaskVenomMeleeAttack : AiTaskBase, IWorldIntersectionSupplier
    {
        Entity targetEntity;
        ...
        public AiTaskVenomMeleeAttack(EntityAgent entity) : base(entity)
        {
        }
        ...
        public override bool ContinueExecute(float dt)
        {
            ...
            if (!damageInflicted)
            {
                ...
                var pastPoison = BuffManager.GetActiveBuff(targetEntity, "ToxicGasEffect") as ToxicGasEffect;

                if (pastPoison == null || pastPoison.StackAmount < 4)
                {
                    var poison = new ToxicGasEffect();
                    poison.StackAmount = 4;
                    poison.Gas = "acid";
                    poison.Timer = 12;
                    poison.Apply(targetEntity);
                }
