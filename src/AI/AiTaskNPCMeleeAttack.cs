...
{
    public class AiTaskNPCMeleeAttack : AiTaskBase, IWorldIntersectionSupplier
    {
        Entity targetEntity;
        ...
        {
            get { return entity.RightHandItemSlot.Empty ? minDist : entity.RightHandItemSlot.Itemstack.Collectible.AttackRange; }
        }

        public float MinVertDist
        {
            get { return entity.RightHandItemSlot.Empty ? minDist : entity.RightHandItemSlot.Itemstack.Collectible.AttackRange; }
        }
        ...
        public AiTaskNPCMeleeAttack(EntityAgent entity) : base(entity)
        {
        }
        ...
        public override bool ShouldExecute()
        {
            ...
            targetEntity = entity.World.GetNearestEntity(pos, MinDist * fearReductionFactor, MinVertDist * fearReductionFactor, (e) => {
            ...
            if (!damageInflicted)
            {
                ...
                ((EntityAgent)targetEntity).ReceiveDamage(
                    new DamageSource()
                    {
                        ...
                        SourceEntity = entity,
                        Type = damageType,
                        DamageTier = entity.RightHandItemSlot.Empty ? damageTier : entity.RightHandItemSlot.Itemstack.Collectible.ToolTier
                    },
                    (entity.RightHandItemSlot.Empty ? damage : entity.RightHandItemSlot.Itemstack.Collectible.AttackPower) * GlobalConstants.CreatureDamageModifier
                );
        ...
        bool hasDirectContact(Entity targetEntity)
        {
            ...
            if (dist >= MinDist || vertDist >= MinVertDist) return false;
