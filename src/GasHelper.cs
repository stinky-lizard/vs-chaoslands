...
namespace ChaosLands
{
    public class GasHelper : ModSystem
    {
        ...
        public static Dictionary<int, Dictionary<string, float>> GetGasesForChunk(BlockPos pos)
        {
            byte[] data;
        ...
        public static Dictionary<int, Dictionary<string, float>> GetGasesForChunk(IWorldChunk chunk)
        {
            byte[] data;
        ...
        public static Dictionary<string, float> GetGases(BlockPos pos)
        {
        ...
        public static float GetGas(BlockPos pos, string name)
        {
        ...
        public static void SendGasSpread(BlockPos pos, Dictionary<string, float> gases, bool mainThread = false)
        {
        ...
        public static TreeAttribute SerializeGasTreeData(BlockPos pos, Dictionary<string, float> gases)
        {
        ...
        public static float GetAirAmount(BlockPos pos)
        {
            Dictionary<string, float> gasesHere = GetGases(pos);
        ...
        public static float GetAcidity(BlockPos pos)
        {
            Dictionary<string, float> gasesHere = GetGases(pos);
        ...
        public static bool IsVolatile(BlockPos pos)
        {
            Dictionary<string, float> gasesHere = GetGases(pos);
        ...
        public static bool ShouldExplode(BlockPos pos)
        {
            Dictionary<string, float> gasesHere = GetGases(pos);
        ...
        public static Dictionary<string, float> CollectGases(BlockPos pos, int radius, string[] gasFilter)
        {
        ...
        public static bool SolidCheck(Block block, BlockFacing face)
        {
