...
namespace ChaosLands
{
    public class InventoryNPCGear : InventoryBase
    {
        ...
        public InventoryNPCGear(string className, string id, ICoreAPI api) : base(className, id, api)
        {
            slots = GenEmptySlots(27);
            baseWeight = 2.5f;
        }

        public InventoryNPCGear(string inventoryId, ICoreAPI api) : base(inventoryId, api)
        {
            slots = GenEmptySlots(27);
            baseWeight = 2.5f;
        }
        ...
        protected override ItemSlot NewSlot(int slotId)
        {
            ...
            if (slotId == 15) return new ItemSlotOffhand(this);
